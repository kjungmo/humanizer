...
프리셋 여섯 개 모두 프롬프트 팩과 회귀 픽스처를 갖췄다.
...
- **3.3.0** - 인스타 게시글·릴스·댓글 프롬프트 팩을 넣어 프리셋 여섯 개가 모두 팩과 픽스처를 갖췄다. 회귀 채점기가 **분량 규격**(본문 글자수, 해시태그·캡션 블록 제외)과 **줄 단위 상한**(릴스 자막 12자)을 실제로 잰다. 네이버 블로그 대표 픽스처가 1,000~2,000자 규격을 지키지 않던 것을 바로잡았다.
