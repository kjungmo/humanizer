# English pattern pack (en)

Pattern catalog for English prose. Loaded by `SKILL.md` when the input is English.
Section numbers (§1 to §33) are stable and referenced from `SKILL.md` and `README.md`.

This pack is the original [blader/humanizer](https://github.com/blader/humanizer) v2.9.1
catalog, carried over unchanged. See `THIRD-PARTY-NOTICES.md`.
